-- Migration: Enhance pgvector capabilities for RAG system
-- Phase 1: Foundation - Advanced pgvector optimizations
...
CREATE TABLE IF NOT EXISTS query_analytics (
    ...
    query_type TEXT CHECK (query_type IN ('search', 'chat', 'api')),
...
-- Update existing match_documents function to use new optimizations
...
CREATE TABLE IF NOT EXISTS processing_queue (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    document_id UUID REFERENCES documents(id) ON DELETE CASCADE,
    processing_type TEXT CHECK (processing_type IN ('text_extraction', 'chunking', 'embedding', 'transcription')),
...
-- Add embedding cache for frequently accessed content
