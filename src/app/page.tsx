...
export default function HomePage() {
  ...
  const getProcessingProgress = () => {
    if (!stats?.processingStatus) return { percentage: 0, stage: 'No Data', color: 'gray' };
  ...
  return (
    <Box p={8} maxW="1200px" mx="auto">
      <VStack spacing={8} align="stretch">
            ...
            <CardBody>
              <VStack spacing={4} align="stretch">
                <HStack justify="space-between">
                  ...
                  <Badge colorScheme={getProcessingProgress().color} fontSize="sm">
                ...
                <HStack justify="space-between" fontSize="sm" color={textColor}>
                  ...
                  <Text>
                    {stats.processingStatus.embedded + stats.processingStatus.processed} / {stats.totalDocuments} processed
                  </Text>
                </HStack>
                ...
                <SimpleGrid columns={4} spacing={2}>
                  <VStack spacing={1}>
                    ...
                    <Text fontSize="xs" color={textColor}>Pending</Text>
                  </VStack>
                  <VStack spacing={1}>
                  ...
                  <VStack spacing={1}>
                    ...
                    <Text fontSize="xs" color={textColor}>Embedded</Text>
                  </VStack>
                  <VStack spacing={1}>
                    <Text fontSize="lg" fontWeight="bold" color="red.500">
                      {stats.processingStatus.error}
                    </Text>
                    <Text fontSize="xs" color={textColor}>Error</Text>
                  </VStack>
                </SimpleGrid>
              </VStack>
            </CardBody>
        ...
        {/* Charts Section */}
        {mounted && stats?.typeCounts && Object.keys(stats.typeCounts).length > 0 && (
              ...
              <SimpleGrid columns={{ base: 2, md: 4 }} spacing={4}>
                {Object.entries(stats.typeCounts).map(([type, count]) => (
                  <Box key={type} p={4} borderRadius="md" bg={typeBoxBg}>
                    <Text fontWeight="bold" color={headingColor} textTransform="uppercase">
                      {type}
                    </Text>
